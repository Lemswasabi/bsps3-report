\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \node[inputNode, dashed, minimum size=2.5em] (s0) at (-3,0) {$\tiny h^{(\dots)}$};

    \node[inputNode, minimum size=2.5em] (x1) at (-1.5,-1.5) {$\tiny x^{(t-1)}$};
    \node[inputNode, minimum size=2.5em] (s1) at (-1.5,0) {$\tiny h^{(t-1)}$};
    ...
    \node[inputNode, minimum size=2.5em] (x2) at (0,-1.5) {$\tiny x^{(t)}$};
    \node[inputNode, minimum size=2.5em] (s2) at (0,0) {$\tiny h^{(t)}$};
    ...
    \node[inputNode, minimum size=2.5em] (x3) at (1.5,-1.5) {$\tiny x^{(t+1)}$};
    \node[inputNode, minimum size=2.5em] (s3) at (1.5,0) {$\tiny h^{(t+1)}$};
    ...
    \node[inputNode, dashed, minimum size=2.5em] (s4) at (3,0) {$\tiny h^{(\dots)}$};
